...
export const enterpriseMaritimeB2bFinalArticles: SeoArticle[] = [
  {
    ...
    category: "Maritime",
    image: img("maritime.jpeg"),
    imageAlt: "Maritime Starlink connectivity for vessels using Ocean Mode in Nigerian waters",
    imageFile: "maritime.jpeg",
    featured: false,
    serviceCta: {
  ...
  },
  {
    ...
    imageAlt: "Starlink at Niger Delta industrial site context for Escravos and Forcados camp connectivity",
  ...
  },
  {
    ...
    readTime: "13 min read",
    category: "Maritime",
    image: img("maritime5.jpeg"),
    imageAlt: "Marine Starlink environment showing salt-spray exposure risk in Nigerian waters",
    imageFile: "maritime5.jpeg",
    featured: false,
    serviceCta: {
  ...
  },
  {
    ...
    imageAlt: "Enterprise Starlink activation and managed setup for Nigerian businesses",
