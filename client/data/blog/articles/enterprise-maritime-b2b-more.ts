...
export const enterpriseMaritimeB2bMoreArticles: SeoArticle[] = [
  {
    ...
    category: "Maritime",
    image: img("maritime3.jpeg"),
    imageAlt: "Starlink marine install on Nigerian boat requiring DC to AC power design",
    imageFile: "maritime3.jpeg",
    featured: false,
    serviceCta: {
  ...
  },
  {
    ...
    readTime: "14 min read",
    category: "Maritime",
    image: img("maritime2.jpeg"),
    imageAlt: "Vessel deck Starlink install requiring segregated crew and bridge networks",
